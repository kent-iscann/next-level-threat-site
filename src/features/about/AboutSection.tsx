    ...
    <section id="about" className="about section">
      <div className="container">
        <div className="about__content">
          ...
          <p className="about__text">
            Signal & Fracture bridges the gap between scattered open-source intelligence and strategic foresight, empowering individuals and organizations to navigate an increasingly volatile world with clarity and confidence.
          </p>
